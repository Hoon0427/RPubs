...
![시작하세요. 데이터분석 with R](C:\MyRCode\RPubs\Main.jpg)
...
## 3)시각화
### ggplot을 통해 상자 그림의 형태로 성적데이터의 최댓값, 최솟값, 중앙값, 사분편차를 시각홯나 모습이다. 상자 그림 가운데는 중앙값을 의미하는데 중앙값만 보아도 수강 후에 성적이 향상되었음을 알 수 있다.
