...
<p align="center">
  ...
  <b>Github Code: [Hoon0427/RPubs](https://github.com/Hoon0427/RPubs/blob/master/RPubs_titanic.Rmd) <br>
  <b>File Download: [Titanic Data](https://www.kaggle.com/c/titanic/data)</b><br>
</p>
...
#### Pclass에 따른 생존여부에서 사망자으ㅣ수는 Pclass등급에 따라 어느정도 차이를 보이고 있으너, 왼쪽 생존자 막대 그래프에서는 등급에 따른 큰 차이를 보이지 않고 있습니다.
